...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonCheckbox, IonList, IonItem, IonButton, IonIcon, IonLabel, 
  IonGrid, IonRow, IonCol, IonButtons, IonItemDivider, AlertController, ToastController, IonAlert } from '@ionic/angular/standalone';
import { ExploreContainerComponent } from '../explore-container/explore-container.component';
import { TaskService } from '../services/task.service';
import { Itask } from '../interfaces/itask';
import { CommonModule } from '@angular/common';
import { addIcons } from 'ionicons';
import { createOutline, closeCircleOutline, addCircle } from 'ionicons/icons';
...
export class Tab2Page {
  ...
  resetTaskList() 
  {
    ...
    this.taskService.getWeeklyTasks().subscribe((results) => {
      this.tasks = results;
  ...
  // /**
  //  * Helper method to reset the boolean value of check1 property everytime user checks or uncheck this item -- but nothing happened.
  //  * @param check -- initial value of this.check1 in the TS reflected to HTML
  //  */
  // printCheck1(check: any) {
  //   console.log("check is "+ check);
  //   console.log("check1 is "+ this.check1);
  // }

  // /**
  //  * Helper method to reset the boolean value of check2 property everytime user checks or uncheck this item.
  //  * @param check -- initial value of this.check2 in the TS reflected to HTML
  //  */
  // printCheck2(check: any) {
  //   console.log("Now check is "+ check);
  //   this.check2 = !check;
  //   console.log("Now this.check2 is "+ this.check2);
  // }
